SELECT 
    ...
    DATE_PART('day', wl.added - wl.first_seen) AS workload_days_old,
...
WHERE 
    vf.added >= CURRENT_DATE - INTERVAL '4 days' -- recent finding
    AND wl.first_seen < CURRENT_DATE - INTERVAL '4 days' -- workload existed before
ORDER BY 
    workload_days_old DESC;
